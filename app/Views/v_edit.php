            ...
            <div class="collapse navbar-collapse" id="navbarNavDropdown">
                <ul class="navbar-nav ms-auto">
                    ...
                    <<?php if (auth()->loggedIn()) : ?> <li class="nav-item">
                        ...
                        <a class="nav-link active" aria-current="page" href="<?= base_url('home/input') ?>"><i class="fa-regular fa-square-plus"></i> Input</a>
                        </li>
                        <li class="nav-item">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form action="<?= base_url('home/simpan_edit_data/') . '/' . $dataobjek['id'] ?>" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="row">
                            ...
                            <div class="col-8">
                                ...
                                <!-- untuk menyimpan nama file lama dan menyembunyikan nama foto lama dengan hidden -->
                    ...
                    <!-- untuk tombol simpan dengan tipe submit  -->
